...
#'
#' \code{oGRscores} is supposed to score a list of genomic regions together with the significance level.
#'
...
#' df_GR <- oGRscores(data=data, significance.threshold=5e-5)
#' }

oGRscores <- function(data, significance.threshold=5e-2, score.cap=10, verbose=TRUE)
{
